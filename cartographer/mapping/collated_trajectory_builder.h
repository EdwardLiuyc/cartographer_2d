...
// MapBuilder 在添加trajectorybuilder 时添加的就是这个builder
// 构造的时候传入了一个 sensor collator，这个类主要就是用这个 sensor collator 来收集传感器数据
// 并将这些参数传给全局优化的类 （GlobalTrajectoryBuilderInterface） 来做后端的全局匹配
